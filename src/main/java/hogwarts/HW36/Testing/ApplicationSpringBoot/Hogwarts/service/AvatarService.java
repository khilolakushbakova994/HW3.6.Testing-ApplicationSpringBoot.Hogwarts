package hogwarts.HW36.Testing.ApplicationSpringBoot.Hogwarts.service;
...
import hogwarts.HW36.Testing.ApplicationSpringBoot.Hogwarts.repository.AvatarRepository;
...
public class AvatarService {
    ...
    public Avatar findAvatarById(Long studentId) {
        return avatarRepository.findById(studentId).orElse(null);
    }
